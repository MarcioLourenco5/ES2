 ...
 *
 * TU-H15/TI-H02 — authorize('Administrador'):
 ...
 *
 * TU-H14/TI-H01 — importCsv (full chain):
...
// ─────────────────────────────────────────────────────────────────────────────
// TU-H16 / TI-H03 — requireAuth  (CE-RA1, CE-RA2, CE-RA3)
// ─────────────────────────────────────────────────────────────────────────────
describe('TU-H16 / TI-H03 | PE — requireAuth (Unidade middleware)', () => {
...
// ─────────────────────────────────────────────────────────────────────────────
// TU-H15 / TI-H02 — authorize('Administrador')  (CE-AU1, CE-AU2, CE-AU3)
// ─────────────────────────────────────────────────────────────────────────────
describe('TU-H15 / TI-H02 | PE — authorize("Administrador") (Unidade middleware)', () => {
...
// ─────────────────────────────────────────────────────────────────────────────
// TU-H14 / TI-H01 — importCsv com Administrador autenticado  (CE-IC1)
// ─────────────────────────────────────────────────────────────────────────────
describe('TU-H14 / TI-H01 | PE — importCsv controller (full chain)', () => {
