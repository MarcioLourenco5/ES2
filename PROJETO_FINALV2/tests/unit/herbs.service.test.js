...
describe('PE — csvContent válido', () => {
  ...
  test('TU-H01 | CE-H1 | CSV com 2 linhas válidas → imported: 2', () => {
  ...
  test('TU-H09 | CE-H9 | CSV com description opcional → imported: 1', () => {
...
describe('PE — headers case-insensitive', () => {
  ...
  test('TU-H13 | CE-H12 | headers case-insensitive (NAME,scientificName) → imported: 1', () => {
    const csv = 'NAME,scientificName\nManjericão,Ocimum basilicum';
    const result = importHerbsFromCsv(csv);
    expect(result.imported).toBe(1);
    expect(result.skipped).toBe(0);
...
describe('PE — csvContent null/undefined', () => {
  ...
  test('TU-H02 | CE-H2 | csvContent null → erro IMPORT_DATA_REQUIRED', () => {
  ...
  test('TU-H03 | CE-H2 | csvContent undefined → erro IMPORT_DATA_REQUIRED', () => {
...
describe('PE — csvContent string vazia', () => {
  ...
  test('TU-H04 | CE-H3 | csvContent string vazia → erro IMPORT_DATA_REQUIRED', () => {
...
describe('PE — CSV sem dados', () => {
  ...
  test('TU-H05 | CE-H4 | CSV só com header, sem dados → imported: 0', () => {
    const csv = 'name,scientificName';
    const result = importHerbsFromCsv(csv);
...
describe('PE — linhas com campos obrigatórios vazios', () => {
  ...
  test('TU-H06 | CE-H5 | linha com name vazio → skipped: 1', () => {
  ...
  test('TU-H07 | CE-H6 | linha com scientificName vazio → skipped: 1', () => {
    const csv = 'name,scientificName\nCamomila,';
    const result = importHerbsFromCsv(csv);
  ...
  test('TU-H12 | CE-H11 | linha com name só espaços → skipped: 1', () => {
...
describe('PE — tipo inválido (type mismatch)', () => {
  ...
  test('TU-H08 | CE-H7 | csvContent é número → erro IMPORT_INVALID_FORMAT', () => {
...
describe('PE — duplicados', () => {
  ...
  test('TU-H11 | CE-H10 | nome duplicado no existingHerbs → skipped', () => {
    const csv = 'name,scientificName\nManjericão,Ocimum basilicum';
  ...
  test('CSV com nome repetido internamente → ambos importados (não há validação intra-CSV)', () => {
    const csv = 'name,scientificName\nA,A\nA,A';
    const result = importHerbsFromCsv(csv);

    // O serviço não valida duplicados intra-CSV por design (valida apenas contra existingHerbs)
    expect(result.imported).toBe(2);
  });
});
