 ...
 *           schema:
 *             type: object
 *             required: [herbId, type, name, temperature, humidity, luminosity, cycleDays]
 *             properties:
 *               herbId: { type: integer }
 ...
 *       400:
 *         description: Dados inválidos, campos obrigatórios ausentes ou type inválido
 *       403:
 *         description: Plano pontual sem autorização
 *       404:
 *         description: Erva aromática não encontrada para o herbId informado
 */
